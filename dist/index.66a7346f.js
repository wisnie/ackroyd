...
/* eslint-disable no-undef */ const append = R.curry((c, p)=>p.appendChild(c)
);
...
const render = R.compose(append, image);
const app = R.compose(getJSON(render), url1);
app('DEMO_KEY').then((x)=>x(document.body)
);

},{}]},["grPCQ","cdtrO"], "cdtrO", "parcelRequire7008")
